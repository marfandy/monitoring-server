    ...
    <div class="col-lg-12">
        <div class="ribbon-wrapper card">
            ...
            <div class="ribbon-content card-body">
                <form action="<?= base_url('auth/save'); ?>" class="form-horizontal" method="POST">
                    <?= csrf_field(); ?>
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control <?= ($validation->hasError('firstname')) ? 'is-invalid' : ''; ?>" name="firstname" onkeyup="this.value = this.value[0].toUpperCase() + this.value.slice(1);" value="<?= old('firstname'); ?>" placeholder="First Name" autofocus>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="lastname" onkeyup="this.value = this.value[0].toUpperCase() + this.value.slice(1);" value="<?= old('lastname'); ?>" placeholder="Last Name">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="password" class="form-control <?= ($validation->hasError('passwd')) ? 'is-invalid' : ''; ?>" name="passwd" id="passwd" value="<?= old('passwd'); ?>" placeholder="Password">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="password" class="form-control <?= ($validation->hasError('confirmPasswd')) ? 'is-invalid' : ''; ?>" name="confirmPasswd" id="confirmPasswd" value="<?= old('confirmPasswd'); ?>" placeholder="Confirm Password">
