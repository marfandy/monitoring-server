    ...
    <div class="col-lg-12">
        <div class="ribbon-wrapper card">
            ...
            <div class="ribbon-content card-body">
                <form action="<?= base_url('host/save'); ?>" class="form-horizontal" method="POST">
                    <?= csrf_field(); ?>
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="device_name" onkeyup="this.value = this.value[0].toUpperCase() + this.value.slice(1);" value="<?= old('device_name'); ?>" autofocus>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="location" onkeyup="this.value = this.value[0].toUpperCase() + this.value.slice(1);" value="<?= old('location'); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control custom-select" name="categori" id="categori">
                                            ...
                                            <?php foreach ($kategori as $k) : ?>
                                                <option <?= (old('categori') == $k['name']) ? 'selected' : ''; ?> value="<?= $k['name']; ?>"><?= $k['name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
